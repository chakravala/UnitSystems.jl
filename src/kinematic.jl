...
@pure specificweight(U::UnitSystem,S::UnitSystem) = unit(force(U,S)/volume(U,S))
...
@pure radiance(U::UnitSystem,S::UnitSystem) = unit(irradiance(U,S)/solidangle(U,S))
@pure radiantintensity(U::UnitSystem,S::UnitSystem) = unit(power(U,S)/solidangle(U,S))
@pure spectralexposure(U::UnitSystem,S::UnitSystem) = unit(force(U,S)/speed(U,S))
